package proger.savch.camera_app_kotlin_deploma
...
class MainActivity : AppCompatActivity() {
    ...
    val sd = Environment.getStorageDirectory().absolutePath + File.separator + "self" +
            File.separator + "primary" + File.separator + Environment.DIRECTORY_DCIM
    ...
    private fun takePhoto() {
        if (hasNoPermissions()) {
            ...
            fotoapparat
                ?.takePicture()
                ?.saveToFile(File(sd + "${File.separator}" + Date().time.toString() + ".jpg"))
        }
    }
